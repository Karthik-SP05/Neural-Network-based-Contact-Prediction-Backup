...
excel_file1 = 'Our Data (xlsx)/data3(2)/final3.xlsx'  # Replace with your actual file name
...
df = pd.read_excel(excel_file1, usecols='AW:BH')
...
df = pd.read_excel(excel_file1, usecols='BI:BT')
...
df = pd.read_excel(excel_file1, usecols='AO:AQ')
...
df = pd.read_excel(excel_file1,usecols='AR:AT')
...
df = pd.read_excel(excel_file1,usecols='C:N')
...
df = pd.read_excel(excel_file1,usecols='O:Z')
...
input_file = 'Our Data (xlsx)/data3(2)/contacts3(2).xlsx'
...
imu_omega_array = imu_omega_array[6500:16200, :]
imu_acc_array = imu_acc_array[6500:16200, :]
p_array = p_array[6500:16200, :]
q_array = q_array[6500:16200, :]
qd_array = qd_array[6500:16200, :]
v_array = v_array[6500:16200, :]


# Save data as a .mat file
output_file = 'output3_inference.mat'  # Replace with your desired output file name
